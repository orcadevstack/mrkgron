...
export const metadata = {
  ...
  description: "Explore all Mrkgron platform features: communications, analytics, and commerce.",
  openGraph: {
    title: "Platform Features — Mrkgron",
    ...
    url: "https://mrkgron.com/features",
    type: "website",
  },
  twitter: {
      ...
      <main id="main-content" className="pt-16">
        ...
        <div className="bg-white">
          <FeatureGroup
            ...
            sub="Launch and scale digital storefronts, optimize conversions, and coordinate logistics — all from within the Mrkgron platform."
