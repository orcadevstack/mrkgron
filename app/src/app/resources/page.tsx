...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://mrkgron.com/resources",
    type: "website",
  },
  twitter: {
...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "A step-by-step guide to launching a fully functional e-commerce storefront on Mrkgron.",
    date: "March 28, 2026",
    readTime: "5 min read",
    href: "#",
  },
        ...
        <section id="docs" className="py-20 bg-brand-light text-center">
          <div className="max-w-2xl mx-auto px-4">
            ...
            <p className="section-subheading mx-auto text-center mt-3">
              ...
              integration tutorials — everything you need to build on Mrkgron.
            </p>
