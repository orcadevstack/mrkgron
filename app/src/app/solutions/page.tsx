...
const solutions = [
  {
    ...
    sub: "Enterprise teams need a platform that handles scale, compliance, and deep customization without compromise. Mrkgron delivers all three.",
    points: [
  ...
  },
  {
    ...
    sub: "Startups need to move quickly and validate their market. Mrkgron gives you the growth engine to acquire, engage, and retain customers from day one.",
    points: [
        ...
        <section className="py-20 bg-brand-light">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="section-subheading mx-auto text-center mt-3">
              Mrkgron is built to be industry-agnostic — our customers span
