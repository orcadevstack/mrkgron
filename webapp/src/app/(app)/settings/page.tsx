    ...
    <div className="space-y-6">
      <section className="app-surface p-8 lg:p-10">
        ...
        <p className="page-copy">
          Configure the defaults that shape how your team uses LizConMart day to day, from notifications to workspace governance.
        </p>
      </section>
      ...
      <section className="grid gap-6 xl:grid-cols-3">
        ...
        <div className="app-panel p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600">
            LizConMart uses a controlled navy, blue, and gold palette throughout the workspace to preserve visual continuity and readability.
          </p>
